...
public class MusicNFTContractWrapper extends Contract implements MusicNFTContract {
    ...
    @Deprecated
    public MusicNFTContractWrapper(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    public MusicNFTContractWrapper(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    public MusicNFTContractWrapper(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public MusicNFTContractWrapper(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public static List<LogEventEventResponse> getLogEventEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(LOGEVENT_EVENT, transactionReceipt);
    ...
    public Flowable<LogEventEventResponse> logEventEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, LogEventEventResponse>() {
            ...
            public LogEventEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(LOGEVENT_EVENT, log);
                LogEventEventResponse typedResponse = new LogEventEventResponse();
                typedResponse.log = log;
                typedResponse.msgSender = (String) eventValues.getNonIndexedValues().get(0).getValue();
                typedResponse.logMsg = (String) eventValues.getNonIndexedValues().get(1).getValue();
    ...
    public RemoteFunctionCall<TransactionReceipt> mintMusicNFT(String to, String coverImageUrl, String creatorNickname, String trackTitle, String nftImageUrl, String combination) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_MINTMUSICNFT,
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, to),
                        new org.web3j.abi.datatypes.Utf8String(coverImageUrl),
                        new org.web3j.abi.datatypes.Utf8String(creatorNickname),
                        new org.web3j.abi.datatypes.Utf8String(trackTitle),
                        new org.web3j.abi.datatypes.Utf8String(nftImageUrl),
                        new org.web3j.abi.datatypes.Utf8String(combination)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    @Deprecated
    public static MusicNFTContractWrapper load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new MusicNFTContractWrapper(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static MusicNFTContractWrapper load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new MusicNFTContractWrapper(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static MusicNFTContractWrapper load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new MusicNFTContractWrapper(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static MusicNFTContractWrapper load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new MusicNFTContractWrapper(contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public static RemoteCall<MusicNFTContractWrapper> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider, String katTokenAddress) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, katTokenAddress)));
        return deployRemoteCall(MusicNFTContractWrapper.class, web3j, credentials, contractGasProvider, BINARY, encodedConstructor);
    }

    public static RemoteCall<MusicNFTContractWrapper> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider, String katTokenAddress) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, katTokenAddress)));
        return deployRemoteCall(MusicNFTContractWrapper.class, web3j, transactionManager, contractGasProvider, BINARY, encodedConstructor);
    }

    @Deprecated
    public static RemoteCall<MusicNFTContractWrapper> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String katTokenAddress) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, katTokenAddress)));
        return deployRemoteCall(MusicNFTContractWrapper.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    @Deprecated
    public static RemoteCall<MusicNFTContractWrapper> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, String katTokenAddress) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, katTokenAddress)));
        return deployRemoteCall(MusicNFTContractWrapper.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }
    ...
    public static class MusicNFTData extends DynamicStruct {
        ...
        public MusicNFTData(String nftImageUrl, String coverImageUrl, String creatorNickname, BigInteger createdDate, String trackTitle, String combination) {
            super(new org.web3j.abi.datatypes.Utf8String(nftImageUrl),
                    new org.web3j.abi.datatypes.Utf8String(coverImageUrl),
                    new org.web3j.abi.datatypes.Utf8String(creatorNickname),
                    new org.web3j.abi.datatypes.generated.Uint256(createdDate),
                    new org.web3j.abi.datatypes.Utf8String(trackTitle),
                    new org.web3j.abi.datatypes.Utf8String(combination));
    ...
    public static class SaleInfo extends StaticStruct {
        ...
        public SaleInfo(Boolean isSelling, BigInteger price) {
            super(new org.web3j.abi.datatypes.Bool(isSelling),
                    new org.web3j.abi.datatypes.generated.Uint256(price));
